...
from Api_endpoint.query_endpoint import router as query_router
from Api_endpoint.get_endpoint import router as get_router
from Api_endpoint.upload_endpoint import router as upload_router
